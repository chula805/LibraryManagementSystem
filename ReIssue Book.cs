...
namespace Library_Management_System
{
    public partial class ReIssue_Book : UserControl
    {
        ...
        public ReIssue_Book() => InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text != "")
            {
                ...
                if (Data.Tables[0].Rows.Count >= 1)
                {
                    ...
                    Connection1.ConnectionString = "Data Source=DESKTOP-JUF5HQI\\SQLEXPRESS;Initial Catalog=LibraryManagementSystem;Integrated Security=True";
